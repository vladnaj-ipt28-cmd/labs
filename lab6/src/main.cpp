...
int main() {
    ...
    const std::string windowName = "Lab 6: OpenCV Video Processing";
    cv::namedWindow(windowName, cv::WINDOW_AUTOSIZE);

    std::cout << "Програму запущено успішно!" << std::endl;
    std::cout << "Керування: 0-4 зміна ефектів, ESC або Q для виходу." << std::endl;
